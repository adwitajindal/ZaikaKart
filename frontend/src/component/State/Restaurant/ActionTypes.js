...
export const GET_RESTAURANTS_EVENTS_SUCCESS="GET_ALL_EVENTS_RESTAURANTS_SUCCESS";
export const GET_RESTAURANTS_EVENTS_FAILURE="GET_ALL_EVENTS_RESTAURANTS_FAILURE";
