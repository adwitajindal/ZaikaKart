...
export const CLEARE_CART_REQUEST="CLEAR_CART_REQUEST";
export const CLEARE_CART_SUCCESS="CLEAR_CART_SUCCESS";
export const CLEARE_CART_FAILURE="CLEAR_CART_FAILURE";
